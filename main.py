...
class Blockchain:
    ...
    def proof_of_authority(block):
        # proof of authority CLIQUE based algorithm implemented
        ...
        # returns the signed hash of this block
        return signed_hash
...
# voting endpoint visible only through the 8000 port
# as it is the core member in the blockchain
